    ...
    function featuredFarms(row, index) {
      ...
      <div class="row">
            <div class="col-lg-4">
              ...
              <p><a class="btn btn-agriculture readmore" href="#" onclick="window.open('../Data Tool/details_page.html','_blank')" id="${row[index]['farm_name']}">Learn More &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
              <img src="./home/images/farm2.jpg" class="img-thumbnail">
              <h2>${row[index+1]['farm_name']}</h2>
              <p>${row[index+1]['additional_info']}</p>
              <p><a class="btn btn-agriculture readmore" href="#" onclick="window.open('../Data Tool/details_page.html','_blank')" id="${row[index+1]['farm_name']}">Learn More &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
              <img src="./home/images/farm1.jpg" class="img-thumbnail">
              <h2>${row[index+2]['farm_name']}</h2>
              <p>${row[index+2]['additional_info']}</p>
              <p><a class="btn btn-agriculture readmore" href="#" onclick="window.open('../Data Tool/details_page.html','_blank')" id="${row[index+2]['farm_name']}">Learn More &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
          </div><!-- /.row -->`;
